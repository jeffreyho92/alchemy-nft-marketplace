...
export class NFTMarketplace extends ethereum.SmartContract {
  ...
  s_listPrice(): BigInt {
    let result = super.call("s_listPrice", "s_listPrice():(uint256)", []);

    return result[0].toBigInt();
  }

  try_s_listPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("s_listPrice", "s_listPrice():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class UpdateListPriceCall extends ethereum.Call {
  get inputs(): UpdateListPriceCall__Inputs {
    return new UpdateListPriceCall__Inputs(this);
  }

  get outputs(): UpdateListPriceCall__Outputs {
    return new UpdateListPriceCall__Outputs(this);
  }
}

export class UpdateListPriceCall__Inputs {
  _call: UpdateListPriceCall;

  constructor(call: UpdateListPriceCall) {
    this._call = call;
  }
...
export class UpdateListPriceCall__Outputs {
  _call: UpdateListPriceCall;
